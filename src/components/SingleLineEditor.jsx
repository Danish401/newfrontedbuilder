...
import { setActiveField, updateField } from "../features/formSlice";

const SingleLineEditor = ({ field }) => {
  ...
  const handleSave = () => {
    dispatch(
      updateField({ id: field.id, label, placeholder, helpText, required })
    );
    dispatch(setActiveField(null)); // Close the editor
  };
